...
#End Region
    ...
    Private Sub WorkerFileCount_Routine()
        RaiseEvent WorkerStatusMessage("Running Line Generator Operation", 1)
        ...
        RaiseEvent WorkerStatusMessage("Line Generator Operation Completed", 1)
        ...
        Try
            ...
            If previousline.Count > 0 Then
                ...
                For Each res As String In previousline
                    ...
                    'Else
                    filewriter.WriteLine(searchterm.Replace("#@#", res))
                        fullcount = fullcount + 1
                        RaiseEvent WorkerFileCount(fullcount, 2)
                        Activity_Logger("Generated Line: " & res)
                    'End If
                Next
            Else
                RaiseEvent WorkerFileCount(fullcount, 2)
